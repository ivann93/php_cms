...
//        
        ...
        <div id="page-wrapper">
            ...
            <?php
                ...
                $unnaproved_comment_counts = mysqli_num_rows($unnaproved_comments);
                //echo $unnaproved_comment_counts;
        ...
        var data = google.visualization.arrayToDataTable([
          ['Data', 'Count'],
            ...
            <?php
                ...
                $element_count = [$post_counts, $post_published_counts, $post_draft_counts, $comment_counts, $unnaproved_comment_counts, $user_counts, $subscriber_counts, $category_counts];
